...
// Servo speed control
int duty_change_per_interval;     // maximum duty erence per interval
...
float volt_to_distance(int a_value)
{
  // Replace next line into your own equation
   return (6762.0 / (a_value - 9) - 4.0) * 10.0 - 50; 
  //return  643 + -3.33*(a_value) + (5.62E-03)*pow(a_value,2);;
}
